...
start your message with a verb if u want to learn him a yes no infos like "are Humens real" it will ask u if they are real and learn
the database is written in germany and the gramatik is on germany for other langues do the database into the googletranslater
